...
module tb_single_core;
    initial begin
        $dumpfile("build_iverilog/tb_single_core.vcd");
        $dumpvars(0, tb_single_core);
        $display("[TB] Start time=%0t, HEX_FILE=%s", $time, HEX_FILE);
    end
    parameter HEX_FILE = "/home/law/ISS-RV32ICMFA/Verilog/spike/hexfile.txt";     
    // -------------------------------------------------------------------------
