...
module tb_amoadd_w;
    ...
    initial begin
        ...
        #10;
        valid_input = 1; rs1 = 32'h1000; rs2 = 32'd5; mem_rdata = 32'd10;
        #10;
        valid_input = 1; rs1 = 32'h2000; rs2 = -32'd3; mem_rdata = 32'd8;
        #10;
        valid_input = 1; rs1 = 32'h3000; rs2 = 32'd15; mem_rdata = -32'd5;
        #10;
        valid_input = 0;
