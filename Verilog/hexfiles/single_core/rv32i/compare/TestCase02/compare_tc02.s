<FILE filename="compare_tc02.s" size="5120 bytes">
    .section .text
    .globl _start
    .option norvc
...
_start:
    ...
    ####################################################################
    # TEST 1: slt 0x55555555 < 0xAAAAAAAA -> 1 (signed)
    ####################################################################
    addi s0, x0, 1
    lui  t0, 0x55555
    addi t0, t0, 0x555
    ...
    ####################################################################
    # TEST 2: sltu 0x55555555 < 0xAAAAAAAA -> 1 (unsigned)
    ####################################################################
    addi s0, x0, 2
    sltu t2, t0, t1
    addi t3, x0, 1
    ...
    ####################################################################
    # TEST 3: slt 0x80000000 < 0 -> 1 (signed)
    ####################################################################
    addi s0, x0, 3
    lui  t0, 0x80000
    addi t1, x0, 0
