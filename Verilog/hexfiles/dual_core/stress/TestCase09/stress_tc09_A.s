...
# GROUP: STRESS
# TESTCASE: 09
# TEST MÔ TẢ: Dual-core Stress full test - Mixed Synchronization + Atomic Contention + False Sharing (TestCase 09)
...
heavy_loop:
    ...
    # Sub 16-20: Boundary + random + chained
