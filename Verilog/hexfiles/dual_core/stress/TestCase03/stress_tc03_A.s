...
# GROUP: STRESS
# TESTCASE: 03
# TEST MÔ TẢ: Dual-core Stress full test - Heavy Memory + False Sharing + Mixed Atomic Contention (TestCase 03)
...
# Trường hợp đặc biệt: 20 sub-test bao gồm heavy loop 2000+ lần, random address, overlapping, signed/unsigned boundary, false sharing, mixed atomic+memory.
# ========================================================
...
heavy_loop:
    # Sub 1-5: Heavy memory write + overlapping
    ...
    # Sub 6-10: Negative offset + unaligned + x0
    ...
    # Sub 11-15: False sharing heavy (same cache line)
