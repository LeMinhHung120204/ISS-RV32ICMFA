...
# TESTCASE: 06
# TEST MÔ TẢ: Dual-core Synchronization full test - Spinlock + Mutex + Semaphore + Producer-Consumer + Barrier (TestCase 06)
...
test_loop:
    ...
    # Sub 6-10: Mutex with nested attempt
    li   t0, 1
    amoswap.w t4, t0, (t1)
    li   t0, 0x11223344
    sw   t0, 0(t5)
    ...
    # Sub 11-14: Semaphore P/V multiple times
    li   t0, 1
    amoadd.w t4, t0, (t2)
    li   t0, -1
    amoadd.w t4, t0, (t2)
    ...
    # Sub 19-20: Barrier + false sharing + random pattern
    li   t0, 0x99AABBCC
    sw   t0, 0(t5)
    li   t0, 1
    amoswap.w t4, t0, (t3)
