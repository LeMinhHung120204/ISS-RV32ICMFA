...
# TESTCASE: 02
# TEST MÔ TẢ: Dual-core Synchronization full test - Spinlock + Mutex + Semaphore + Producer-Consumer (TestCase 02)
...
test_loop:
    ...
    li   t0, 1
    amoswap.w t4, t0, (t1)          # acquire spinlock
    ...
    # Sub 19-20: Barrier simulation + false sharing + random pattern
    li   t0, 0x99AABBCC
    sw   t0, 0(t5)
    li   t0, 1
    amoswap.w t4, t0, (t3)
