...
# GROUP: SHARED_MEMORY
# TESTCASE: 04
# TEST MÔ TẢ: Dual-core Shared Memory full access test - Core A writes all possible edge cases (TestCase 04)
...
test_loop:
    ...
    # Sub 17: False sharing potential
    li   t0, 0x11223344
    sw   t0, 64(t1)

    # Sub 18: Random pattern 1
    li   t0, 0x9ABCDEF0
    sw   t0, 68(t1)

    # Sub 19: Random pattern 2
    li   t0, 0x12345678
    sw   t0, 72(t1)

    # Sub 20: Final deadbeef
    li   t0, 0xCAFEBABE
    sw   t0, 76(t1)
