...
# GROUP: ATOMIC
# TESTCASE: 03
# TEST MÔ TẢ: Dual-core Atomic full test - lr.w/sc.w + AMO contention (TestCase 03)
# Core B polling verify. Test startup skew + atomicity + reservation + x0 discard + signed/unsigned + bit pattern + boundary
# Trường hợp đặc biệt: 20 sub-test bao gồm lr/sc success/fail, tất cả AMO, x0 discard, overflow, false sharing.
# ========================================================
...
test_loop:
    ...
    # Sub 1-5: lr.w/sc.w success/fail
    lr.w t0, (t1)
    li   t2, 0xDEADBEEF
    sc.w t4, t2, (t1)
