...
HD_PWD='C:/Law/KLTN/ISS-RV32ICMFA/RISCV/RISCV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atomic_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atomic_decoder.tcl
