...
module tb_amomin_w;
    ...
    initial begin
        ...
        #10;
        // Test 1: min(20, 10) = 10
        valid_input = 1; rs1 = 32'h1000; rs2 = 32'd20; mem_rdata = 32'd10;
        #10;
        // Test 2: min(5, 15) = 5
        valid_input = 1; rs1 = 32'h2000; rs2 = 32'd5; mem_rdata = 32'd15;
        #10;
        // Test 3: min(10, 2) = 2
        valid_input = 1; rs1 = 32'h3000; rs2 = 32'd10; mem_rdata = 32'd2;
        #10;
        valid_input = 0;
