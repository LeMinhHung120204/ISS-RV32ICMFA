...
module tb_amoand_w;
    ...
    initial begin
        ...
        #10 rst_n = 1;
        #10;
        // Test 1: 0xF0 AND 0x0F = 0x00
        valid_input = 1; rs1 = 32'h1000; rs2 = 32'h0F;
        #10 valid_input = 0;
        #10 axi_arready = 1;
        #10 axi_arready = 0;
        #10 axi_rvalid = 1; axi_rdata = 32'hF0;
        #10 axi_rvalid = 0;
        ...
        #10 axi_bvalid = 0;
        #30;
        // Test 2: 0xFF AND 0xAF = 0xAF
        valid_input = 1; rs1 = 32'h2000; rs2 = 32'hAF;
        #10 valid_input = 0;
        #10 axi_arready = 1;
        #10 axi_arready = 0;
        #10 axi_rvalid = 1; axi_rdata = 32'hFF;
        #10 axi_rvalid = 0;
        #10 axi_awready = 1; axi_wready = 1;
        #10 axi_awready = 0; axi_wready = 0;
        #10 axi_bvalid = 1;
