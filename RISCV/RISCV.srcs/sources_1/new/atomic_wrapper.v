...
module atomic_wrapper #(
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            // Capture inputs
            // Fix: Invalidate on ACE invalidating transactions:
            // ReadUnique (0111), CleanUnique (1011), MakeInvalid (1101)
            snoop_invalidate_reg <= snoop_valid && (
                snoop_type == 4'b0111 || // ReadUnique
                snoop_type == 4'b1011 || // CleanUnique
                snoop_type == 4'b1101    // MakeInvalid
            );
